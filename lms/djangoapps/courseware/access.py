...
def _has_access_course_desc(user, action, course):
    ...
    'enrolled_load_mobile' -- can an enrolled user load from a mobile context
    ...
    checkers = {
        ...
        'enrolled_load_mobile': can_enrolled_load_mobile,
        'enroll': can_enroll,
